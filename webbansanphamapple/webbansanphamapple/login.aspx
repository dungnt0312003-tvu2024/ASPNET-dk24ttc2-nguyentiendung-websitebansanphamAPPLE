<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Default.Master" CodeBehind="login.aspx.cs" Inherits="webbansanphamapple.login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark fixed-top">
        ...
        <ul class="navbar-nav ms-auto col-md-2">
            <li class="nav-item">
                <a class="nav-link  active" href="login.aspx">Đăng nhập</a>
            </li>
            <li class="nav-item">
